...
def calc_shortest_step_combination(wire_data, circuit_array):
    central_port = wire_data['central_port']
    intersections_wire_1 = count_steps(
        wire_data['wire_1'], circuit_array, central_port)
    intersections_wire_2 = count_steps(
        wire_data['wire_2'], circuit_array, central_port)

    smallest_combination = math.inf
    for intersection_wire_1 in intersections_wire_1:
        for intersection_wire_2 in intersections_wire_2:
            if intersection_wire_1['x'] == intersection_wire_2['x'] and intersection_wire_1['y'] == intersection_wire_2['y']:
                combined_steps = intersection_wire_1['steps'] + \
                    intersection_wire_2['steps']

                if combined_steps < smallest_combination:
                    smallest_combination = combined_steps
...
def main():
    ...
    for wire_data in wires:
        ...
        shortest_step_combination = calc_shortest_step_combination(
            wire_data, circuit_array)
        ...
        assert shortest_step_combination == wire_data['minimal_steps']
